...
export class LocatorHelper {
  ...
  async findElement(
    ...
    throw new Error(
      `Could not locate element with selector: ${primarySelector}. All fallback strategies failed.`
    );
  }
   ...
   */
  async clickElement(selector: string, options: LocatorOptions = {}): Promise<void> {
   ...
   */
  async waitForElement(selector: string, options: LocatorOptions = {}): Promise<void> {
