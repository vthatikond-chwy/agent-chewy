...
export class VisionHealer {
    openai;
    screenshotDir;
    constructor(apiKey, screenshotDir = '.temp/screenshots') {
     ...
     */
    async findElementWithVision(page, description, context) {
        // Take a screenshot
        const screenshotPath = path.join(this.screenshotDir, `vision-${Date.now()}.png`);
...
//# sourceMappingURL=visionHealer.js.map