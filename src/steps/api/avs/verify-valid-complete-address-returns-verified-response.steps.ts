...
Given('the request body for verify-valid-complete-address-returns-verified-response is prepared with the following details', function (this: CustomWorld, dataTable) {
...
When('I send a POST request for verify-valid-complete-address-returns-verified-response to the address verification service', async function (this: CustomWorld) {
  try {
...
Then('the HTTP response status for verify-valid-complete-address-returns-verified-response should be 200', function (this: CustomWorld) {
